...
L.ALS.Layer = L.ALS.Widgetable.extend({
	...
	initialize: function(layerSystem, args, settings) {
		...
		handle.className = "layer-handle las la-arrows-alt";
		...
		menuButton.className = "las la-cog";
		...
		this._hideButton.className = "las la-eye";
		L.ALS.Helpers.makeHideable(this._hideButton, undefined, () => {
			this._hideButton.className = "las la-eye-slash";
			this._onHide();
			this.onHide();
		}, () => {
			this._hideButton.className = "las la-eye";
